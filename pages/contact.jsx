        ...
        <BannerLayout>
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-5 text-xs">
                        <div className="card_stylings w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className='text-LightGray md:text-sm'>Trixs Technologies</span>
                            </div>
                        </div>
                        <div className="card_stylings rounded-xl w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <span className='text-LightGray text-sm'>www.linkedin.com/in/ashishverma 2594a528a</span>
                            </div>
                            <div className="flex justify-between items-center">
            ...
            {isOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-MidNightBlack p-6 rounded-lg max-w-md w-full backdrop-blur-3xl drop-shadow-2xl">
                        <div className='flex flex-col items-center justify-center'>
                            ...
                            <button 
                                className="mt-4 px-4 py-2 bg-DarkGray text-Snow rounded hover:bg-SlateGray"
